...
def make_visualization(
    ori_img: Image, source: torch.Tensor, patch_size: int = 16, class_token: bool = True
) -> Image:
    """
    ...
    return overlay_img(ori_img, vis_img, 0.25)
...
if __name__ == '__main__':
   ...
   make_visualization(image_vis, source)
